...
> The YAML header above is copied as-is, and technical terms remain in English.

# (Original H1 Title)

_(Explanation)_ Describe the purpose, context, and use case of this section in Korean.

## (Original H2 Title)

_(Explanation)_ Summarize key concepts, inputs/outputs, and constraints.
...
_(Explanation)_ Explain what the code does, its flow, and potential side effects or exceptions.
...
_(Explanation)_ Describe the key point of this table.
